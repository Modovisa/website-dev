        ...
        <Card className="p-8 mb-8">
          ...
          <div className="mb-8">
            <p className="text-lg text-muted-foreground mb-4">
              The recommended way to add Modovisa to Drupal is through the site's <span className="font-semibold text-foreground">HTML &lt;head&gt;</span> settings.
              Paste your <span className="font-semibold text-foreground">Tracking Token</span> and the script will load on all pages automatically.
            </p>
          ...
          <div className="mb-8">
            ...
            <ol className="space-y-3 list-decimal list-inside text-muted-foreground">
              <li>Log in to your Drupal admin dashboard.</li>
              <li>Navigate to <span className="font-semibold text-foreground">Appearance → Settings</span> (for your active theme).</li>
              <li>Scroll down to <span className="font-semibold text-foreground">Advanced Settings</span> or look for a field labeled <span className="font-semibold text-foreground">HTML Head</span> or <span className="font-semibold text-foreground">Scripts</span>.</li>
              <li>Paste the Modovisa tracking script below.</li>
              <li>Click <span className="font-semibold text-foreground">Save configuration</span>.</li>
              <li>Clear your Drupal cache: <span className="font-semibold text-foreground">Configuration → Performance → Clear all caches</span>.</li>
            </ol>
          </div>
          ...
          <div>
            ...
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                If you use Varnish or a CDN, purge your cache after installation to ensure the script loads immediately.
              </p>
            </div>
          </div>
        </Card>
