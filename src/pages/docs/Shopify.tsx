        ...
        <Card className="p-8 mb-8">
          ...
          <div className="mb-8">
            <p className="text-lg text-muted-foreground mb-4">
              ...
              . Once installed, you'll just need to paste your <span className="font-semibold text-foreground">Tracking Token</span> inside the App Embed section.
            </p>
            ...
            <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg">
              ...
              <p className="text-sm text-blue-900 dark:text-blue-100">
                Works with <span className="font-semibold">Online Store 2.0</span> themes and newer. Requires no Liquid edits or code changes — everything is handled through the Theme Editor.
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <ol className="space-y-4 list-decimal list-inside text-muted-foreground">
              <li>
                ...
                and copy your <span className="font-semibold text-foreground">Tracking Token</span> for this store (found under <em>Account → Tracked Sites</em> or on the <em>Installation</em> page).
              </li>
              <li>
                ...
                <ul className="ml-6 mt-2 space-y-1 list-disc">
                  ...
                  <li>Set up your first website to generate a <span className="font-semibold text-foreground">Tracking Token</span>.</li>
                </ul>
              </li>
              <li>
                Go to the official{" "}
                ...
                on the Shopify App Store and click <span className="font-semibold text-foreground">Install</span>.
              </li>
              <li>After installation, you'll be directed to the Modovisa App page.</li>
              <li>Click on the <span className="font-semibold text-foreground">Open Theme editor → App embeds</span> button.</li>
              <li>You'll be directed to the Shopify <span className="font-semibold text-foreground">Theme Editor</span>.</li>
              <li>You'll find the Modovisa App embed on the top left.</li>
              <li>
                Find <span className="font-semibold text-foreground">Modovisa Analytics</span> and toggle it{" "}
                <span className="inline-flex items-center gap-1">
                  ON
                  <svg width="34" height="22" viewBox="0 0 34 22" xmlns="http://www.w3.org/2000/svg" className="inline-block ml-1">
              ...
              <li>Paste your <span className="font-semibold text-foreground">Tracking Token</span> into the field labeled "Modovisa tracking token".</li>
          ...
          <div className="mb-8 flex items-start gap-3 p-4 bg-muted rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              You don't need to add code manually — the app embed handles this automatically once enabled. Your <span className="font-semibold">Tracking Token</span> securely links the store to your Modovisa dashboard.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc list-inside text-muted-foreground">
              ...
              <li>Once detected, go to your Modovisa dashboard → <span className="font-semibold text-foreground">Live Insights</span> to confirm your visit appears in real time.</li>
            </ul>
          </div>
        </Card>
