      ...
      <div className="container max-w-8xl mx-auto py-12 px-6">
        ...
        <div className="text-center mb-12">
          ...
          <Badge className="bg-primary/10 text-primary px-6 py-2 text-sm">
            Add the Modovisa tracking script via Script Manager to start real-time analytics.
          </Badge>
        </div>
        ...
        <Card className="p-8 mb-8">
          ...
          <div className="mb-8">
            <p className="text-lg text-muted-foreground mb-4">
              The recommended way to add Modovisa to BigCommerce is through the <span className="font-semibold text-foreground">Script Manager</span>. 
              This allows you to add your <span className="font-semibold text-foreground">Tracking Token</span> without editing theme files directly.
            </p>
          ...
          <div className="mb-8">
            ...
            <ol className="space-y-3 list-decimal list-inside text-muted-foreground">
              ...
              <li>Navigate to <span className="font-semibold text-foreground">Storefront → Script Manager</span>.</li>
              <li>Click <span className="font-semibold text-foreground">Create a Script</span>.</li>
              <li>Enter a name like "Modovisa Analytics".</li>
              <li>For <span className="font-semibold text-foreground">Placement</span>, select <span className="font-semibold text-foreground">Head</span>.</li>
              <li>For <span className="font-semibold text-foreground">Location</span>, select <span className="font-semibold text-foreground">All pages</span>.</li>
              <li>For <span className="font-semibold text-foreground">Script category</span>, select <span className="font-semibold text-foreground">Essential</span> or <span className="font-semibold text-foreground">Analytics</span>.</li>
              <li>For <span className="font-semibold text-foreground">Script type</span>, select <span className="font-semibold text-foreground">Script</span>.</li>
              <li>Paste the Modovisa tracking script below into the script contents field.</li>
          ...
          <div>
            ...
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                If you don't see events immediately, clear your browser cache and try in an incognito window.
              </p>
            </div>
          </div>
        </Card>
