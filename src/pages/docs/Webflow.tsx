        ...
        <Card className="p-8 mb-8">
          ...
          <div className="mb-8">
            <p className="text-lg text-muted-foreground mb-4">
              ...
              to add Modovisa in Webflow is via your project&apos;s{" "}
            ...
            <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg">
              ...
              <p className="text-sm text-blue-900 dark:text-blue-100">
                ...
                and mapped to your domain. Custom code runs only on the
          ...
          <div className="mb-8">
            ...
            <ol className="space-y-3 list-decimal list-inside text-muted-foreground">
              ...
              <li>
                ...
                , paste the Modovisa snippet below.
              </li>
              <li>
                Click{" "}
                <span className="font-semibold text-foreground">
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc list-inside text-muted-foreground">
              ...
              <li>
                ...
                watch your own visit in real time.
              </li>
            </ul>
          </div>
        </Card>
