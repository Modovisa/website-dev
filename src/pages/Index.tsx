...
import { ArrowRight, Eye, BarChart2, Zap, Shield, Globe, Clock, Package, Briefcase, Check, Menu, LogIn } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden flex items-center">
        ...
        <div className="container relative mx-auto px-4 pt-6 pb-20 z-10">
          {/* Glass-style Navbar */}
          <nav className="glass-nav rounded-full px-6 py-4 mb-16">
