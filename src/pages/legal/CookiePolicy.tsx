            ...
            <div className="space-y-6 md:space-y-7 text-sm md:text-base leading-relaxed text-muted-foreground">
              ...
              <section>
                ...
                <p>
                  ...
                  visit a website. They help websites function, remember user
                  preferences, and collect information for analytics. Cookies may
                  be session-based (deleted when you close your browser) or
              ...
              <section>
                ...
                <p>
                  When you use Modovisa or when our tracking script is installed
                  on a customer&apos;s website, we may set the following
                  first-party cookies:
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    <strong>modovisa_session_id</strong> — Session identifier,
                    used to group page views into one browsing session. Expires
              ...
              <section>
                ...
                <p>
                  ...
                  Modovisa tracking will only start once you explicitly agree to
                  the use of cookies. A banner will be shown asking: &quot;We use
                  a visitor ID cookie to measure website traffic. Do you
                  consent?&quot;
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  browser settings. If you choose to disable cookies, some
                  analytics functionality may not work correctly.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  as GDPR or CCPA to access, delete, or object to the use of
                  cookies associated with your data. To exercise these rights,
