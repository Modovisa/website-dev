...
export const GuidesNavbar = () => {
  ...
  // collapsible state inside mobile sheet (all collapsed by default)
            ...
            {isAuthed ? (
              <>
                <Link to="/app/live-tracking">
                  <Button
                    variant="outline"
                    className="rounded-md border-transparent bg-white/50 px-6 py-2.5 text-base font-semibold text-foreground hover:bg-white/75 hover:text-foreground"
                  >
                    Live Tracking
                  </Button>
                </Link>
