...
// Cast to `any` to avoid "cannot be used as a JSX component" errors
...
export const ReferenceLine  = (R as any).ReferenceLine as unknown as any; // optional
export const ComposedChart  = (R as any).ComposedChart as unknown as any; // optional
