...
// - Rebase: rotates all 24h series by browser TZ (nearest hour) to localize UTC feeds
//   NOTE: half-hour zones are rounded; server-side site TZ bucketing is the exact fix
